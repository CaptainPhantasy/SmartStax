  ...
  return (
    <ScrollView contentInsetAdjustmentBehavior="automatic" className="flex-1 bg-white" style={{ paddingTop: insets.top }}>
      <View className="px-5 py-6 gap-3">
        <Text className="text-gray-900 font-semibold">Catalog JSON</Text>
        <TextInput value={json} onChangeText={setJson} multiline className="border border-gray-200 rounded-md p-3 min-h-[240px]" />
